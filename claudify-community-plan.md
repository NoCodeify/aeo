...
Not video modules. Downloadable resources organized by type:
...
**Total launch effort: 8 video modules + templates + community setup**

This is enough to:
- Deliver on the 21-day milestone (Quick Start path)
- Show depth (DMChamp case study is substantial)
- Give templates to start immediately (Vault)
...
| Month | New Modules | Case Study | Vault Additions |
|-------|------------|------------|-----------------|
...
| Space | Purpose |
|-------|---------|
| Announcements | New modules, updates, events (founder only) |
| Wins | Members share what they built (celebration + social proof) |
| Help & Debug | Get unstuck, share errors, ask questions |
| Show Your Work | Share work-in-progress, get feedback |
| Ideas & Requests | Members request modules, features, templates |
| Coaching Call Replays | Recordings of weekly calls |
| Introductions | New member intros (who are you, what do you want to build) |
...
| Thursday evening | Weekly live coaching call (60-90 min, screen-share, build together) |
| Friday | "What I built this week" Loom from the founder (5-10 min) |
...
2. Hot seat #1 (20 min) - member shares screen, builds/debugs live with founder
3. Hot seat #2 (20 min) - second member
4. Open Q&A (15-20 min) - rapid-fire questions
5. Next week preview (5 min) - what is coming
...
| Join | Auto-tagged to "New Member" - gets pinned onboarding post |
| Day 1 | Watch Module 1 (Setup). Post intro in Introductions. |
| Day 1 | Encouraged to attend next coaching call (or watch replay) |
...
| Day 14 | Module 4 should be complete. Founder follows up. |
...
- **Coaching call attendance streak** - bonus points for showing up consistently

### Anti-churn triggers

- If a member has not logged in for 7 days: founder DM ("Hey, saw you started Module X - need help?")
- If a member is stuck on Module 4 for 14+ days: invite to coaching call hot seat
...
## 9. What This Changes in Existing Docs
...
- Remove "or your money back" from About section and landing page one-liner.
- Rewrite guarantee section: "Build your first working system in 21 days" as a structured path, not a refund promise. The 21-day Quick Start gives members a clear, guided path to their first working Claude Code system. If they follow the modules, attend coaching calls, and do the work, they will have a working system by Day 21. That is the promise.
- Update risk reversal line on landing page accordingly.
- "20+ modules" is fine as a forward-looking statement (the full curriculum reaches 20+ by Month 7).
