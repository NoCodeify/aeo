      ...
      >
          ...
          >
            ...
            <div className="font-mono space-y-3" style={{ fontSize: "20px", lineHeight: "1.6" }}>
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/70">meta-ads → landing page → whatsapp</span>
              </div>
              <div className="flex items-center gap-2">
                <span style={{ color: "#28c840" }}>&#10003;</span>
                <span className="text-white/50">AI qualifies lead</span>
              </div>
              <div className="flex items-center gap-2">
                <span style={{ color: "#28c840" }}>&#10003;</span>
                <span className="text-white/50">Books call automatically</span>
              </div>
              <div className="flex items-center gap-2">
                <span style={{ color: "#28c840" }}>&#10003;</span>
                <span className="text-white/50">White-label ready</span>
              </div>
              <div className="flex items-center gap-2 mt-1">
                <span style={{ color: "#00d4ff" }}>$</span>
                <span className="text-white/70">client-result --fuegenix</span>
              </div>
              <div className="flex items-center gap-2">
                <span style={{ color: "#febc2e" }}>&#9654;</span>
                <span style={{ color: "#00d4ff" }}>$15M revenue</span>
                <span className="text-white/30">with AI funnels</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            {/* Main filled area */}
            <path
              d="M 0 380 L 25 375 L 50 378 L 80 370 L 110 374 L 140 362 L 170 350 L 200 340 L 225 348 L 260 325 L 290 335 L 325 305 L 355 318 L 390 275 L 420 290 L 455 230 L 485 210 L 510 155 L 530 120 L 550 60 L 570 35 L 585 15 L 585 380 L 0 380 Z"
              fill="url(#areaFill)"
            />

            {/* The main line */}
            <path
              d="M 0 380 L 25 375 L 50 378 L 80 370 L 110 374 L 140 362 L 170 350 L 200 340 L 225 348 L 260 325 L 290 335 L 325 305 L 355 318 L 390 275 L 420 290 L 455 230 L 485 210 L 510 155 L 530 120 L 550 60 L 570 35 L 585 15"
            ...
            <path
              d="M 455 230 L 485 210 L 510 155 L 530 120 L 550 60 L 570 35 L 585 15"
              stroke="#5ce1ff"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            {/* Dots on every point */}
            <circle cx="0" cy="380" r="3" fill="#00d4ff" opacity="0.7" />
            <circle cx="25" cy="375" r="3" fill="#00d4ff" opacity="0.7" />
            <circle cx="50" cy="378" r="3" fill="#00d4ff" opacity="0.7" />
            <circle cx="80" cy="370" r="3" fill="#00d4ff" opacity="0.7" />
            <circle cx="110" cy="374" r="3" fill="#00d4ff" opacity="0.7" />
            <circle cx="140" cy="362" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="170" cy="350" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="200" cy="340" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="225" cy="348" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="260" cy="325" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="290" cy="335" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="325" cy="305" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="355" cy="318" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="390" cy="275" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="420" cy="290" r="3.5" fill="#00d4ff" opacity="0.7" />
            <circle cx="455" cy="230" r="4" fill="#00d4ff" opacity="0.7" />
            <circle cx="485" cy="210" r="4" fill="#00d4ff" opacity="0.75" filter="url(#glow)" />
            <circle cx="510" cy="155" r="4.5" fill="#00d4ff" opacity="0.8" filter="url(#glow)" />
            <circle cx="530" cy="120" r="4.5" fill="#00d4ff" opacity="0.85" filter="url(#glow)" />
            <circle cx="550" cy="60" r="5" fill="#00d4ff" opacity="0.9" filter="url(#glowStrong)" />
            <circle cx="570" cy="35" r="5.5" fill="#5ce1ff" opacity="0.95" filter="url(#glowStrong)" />
            <circle cx="585" cy="15" r="6" fill="#5ce1ff" opacity="1" filter="url(#glowStrong)" />

            {/* Pulse ring on peak */}
            <circle cx="585" cy="15" r="14" fill="none" stroke="#00d4ff" strokeWidth="1.5" opacity="0.3" />
          </svg>
        </div>
      </div>
    </div>
